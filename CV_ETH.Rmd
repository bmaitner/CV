...
RefManageR::BibEntry(bibtype="Misc", key = "EvoEcol2020", date = "", title = "Next-generation field courses should intergrate Open Science and online learning", author = "Sonya Geange and Jonathan von Oppen and Sara Middleton and Tasha-Leigh Gauthier and Tanya Strydom and Ragnhild Gya and...", journal = "Ecology and Evolution", pubstate = "in prep") %>%
  c(.,RefManageR::BibEntry(bibtype="Misc", key = "HonsMS", date = "", title = "Bush encroachment in South Africa’s montane grasslands: the impact of Leucosidea sericea on microclimate and vegetation", author = "Tanya Strydom and Peter C. le Roux", journal = "", pubstate = "in prep")) %>%
  RefManageR::as.BibEntry() %>%
