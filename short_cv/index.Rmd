...
tribble(
  ...
  # CAN metaweb
  "Canadian metaweb construction working group","PIs: T. Poisot (Université de Montréal) and L.J. Pollock, (McGill University)","Leader as one of the sub-projects focused on using machine learning for prediction", "2021",
  # Network pred synth
