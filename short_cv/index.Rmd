...
tribble(
  ...
  "Doctor of Philosophy: Biological Sciences","Thesis: Common properties of species interactions networks across space", "2020 - Present", "Université de Montréal", "Montréal, Canada",
...
tribble(
  ...
  'Regular Member',  "Québec Centre for Biodiversity Sciences", "2020 - Present",
) %>%
  detailed_entries(
    what = Institution,
    with = Award,
