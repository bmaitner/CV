...
Pavillon Marie-Victorin, PO Box 6128 Centre-ville Stn, Montréal, QC, H3C
3J7 Canada}
...
\section{International Collaboration and Working
Groups}\label{international-collaboration-and-working-groups}}

\begin{cventries}
    \cventry{PIs: T. Poisot (Université de Montréal) and L.J. Pollock, (McGill University)}{Canadian metaweb construction working group}{}{2021}{\begin{cvitems}
\item Leader of one of the sub-projects focused on using machine learning for prediction
\end{cvitems}}
    \cventry{PIs: T. Poisot (Université de Montréal) and L.J. Pollock, (McGill University)}{Network prediction synthesis working group}{}{2020}{\begin{cvitems}
\item Co-lead author of resulting publication
\end{cvitems}}
    \cventry{PIs: V. Vandvik (University of Bergen) and B.J. Enquist, (University of Arizona)}{Plant Functional Trait Course 5 in Peru}{}{2020}{\begin{cvitems}
\item Plant functional responses to fire
\end{cvitems}}
\end{cventries}
...
B}. \url{https://doi.org/10.1098/rstb.2021.0063}
...
\begin{cventries}
    \cventry{Living Norway Colloquium 2020: Towards openess and transparency in applied ecology}{Taking FAIR and open science to the field: The evolution of the PFTC field course}{Virtual}{Oct., 2020}{\begin{cvitems}
\item Presented as part of the education and open science workshop
\item \textbf{Tanya Strydom} alongside Aud H. Halbritter, 109 PFTC Participants
\item \href{https:doi.org/10.5281/zenodo.4117503}{Link to slides}
\end{cvitems}}
\end{cventries}
\vspace{\baselineskip}
...
\begin{cventries}
    \cventry{11th Annual QCBS Symposium}{Exploring the complexity of ecological networks using SVD entropy}{Virtual}{Dec., 2020}{\begin{cvitems}
\item \textbf{Tanya Strydom}, Giulio V. Dalla Riva and Timothée Poisot
\item \href{https://tanyas08.github.io/Talks/2020_Dec_QCBS/index.html}{Link to slides}
\end{cvitems}}
\end{cventries}
...
\begin{cventries}
    \cventry{CSEE-SCEE 2021 Annual Meeting}{Reconstructing food webs using transfer learning}{Virtual}{Aug., 2021}{\begin{cvitems}
\item \textbf{Tanya Strydom}, Salomé Bouskila and Timothée Poisot
\end{cvitems}}
\end{cventries}
...
\begin{cventries}
    \cventry{ATBC Annual Meeting}{Designing a collective prototype of future tropical and subtropical science}{Virtual}{Jul., 2021}{\begin{cvitems}
\item Gracielle Higino, Mickey Boakye, Norma Forero, \textbf{Tanya Strydom}
\item \href{https://graciellehigino.github.io/future.ecology/}{Link to webpage}
\end{cvitems}}
\end{cventries}
...
\begin{cventries}
    \cventry{Fortnightly cartoonist for Ecology for the Masses blog}{Cartoonist}{}{2020 - present}{}\vspace{-4.0mm}
\end{cventries}
\vspace{\baselineskip}
...
\begin{cventries}
    \cventry{Member}{Societry for Open, Reliable, and Transparent Ecology and Evolutionary Biology}{}{2021 - Present}{}\vspace{-4.0mm}
    \cventry{Student Member}{Québec Centre for Biodiversity Sciences}{}{2020 - Present}{}\vspace{-4.0mm}
    \cventry{Plant Ecology, PLoS ONE}{Reviewed Journals}{}{}{}\vspace{-4.0mm}
\end{cventries}
